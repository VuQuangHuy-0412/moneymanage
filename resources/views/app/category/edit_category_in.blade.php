        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Sửa Danh Mục Thu</li>
                </ol>
            </div>
            <div class="container-fluid">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="card-panel panel" id="tab1">
                                        ...
                                        <div id="collapse_{{$d->user_category_id}}" class="panel-collapse collapse" role="tabpanel">
                                            <div class="card-body">
                                                <form method="POST" autocomplete="off" action="{!! route('app.restore-category-in') !!}" class="form-horizontal" enctype="multipart/form-data">
                                                    @csrf
