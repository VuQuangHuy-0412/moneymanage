        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Thêm Danh Mục Thu</li>
                </ol>
            </div>
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card-body">
                        ...
                        <form method="POST" autocomplete="off" action="{!! route('app.store-category-in') !!}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
